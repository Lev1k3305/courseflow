...
## ☁️ Деплой и загрузка в ВКонтакте

### Шаг 1: Публикация сайта на Vercel (Рекомендуется)
1. Создайте бесплатный аккаунт на [Vercel.com](https://vercel.com).
2. Свяжите ваш GitHub репозиторий с проектом.
3. Нажмите кнопку **Deploy**. Вы получите защищенный публичный URL вида `https://courseflow.vercel.app`.

### Шаг 2: Создание приложения в VK Developers
1. Откройте панель управления приложениями **[vk.com/apps?act=manage](https://vk.com/apps?act=manage)**.
2. Нажмите **«Создать приложение»**, укажите название `CourseFlow` и выберите тип **«Мини-приложение (VK Mini Apps)»**.
3. Перейдите в раздел **«Настройки»** приложения.
4. Включите состояние приложения и найдите пункт **«Адреса для запуска»**.
5. Скопируйте ссылку от Vercel и вставьте в поля:
   * **URL для мобильной версии**
   * **URL для десктопной версии**
   * **URL для мобильного сайта**
6. Сохраните изменения.

*Теперь вы можете запустить приложение прямо в ВК, отсканировав QR-код из раздела настроек вашего приложения!*
