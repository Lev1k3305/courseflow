      ...
      <div className="max-w-2xl mx-auto">
        ...
        {isLoading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-zinc-500 dark:text-zinc-400">Загрузка профиля...</p>
          </div>
        ) : (
          <>
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-8 mb-8 flex flex-col sm:flex-row items-center gap-6">
              <div className="relative group">
                <img src={avatarUrl} alt="Avatar" width="96" height="96" className="w-24 h-24 rounded-full border-4 border-indigo-50 dark:border-zinc-700 shadow-inner bg-zinc-100 dark:bg-zinc-800" />
                <input
                  type="text"
                  value={avatarUrl}
